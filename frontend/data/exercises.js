...
export const EXERCISES = {
    ...
    arms: [
        { id: 'a1', name: 'Tricep Dips', sets: 3, reps: 12, restSec: 45, gifName: 'tricep_dips', videoSource: 'tricep_dips', description: 'Using a chair, lower body by bending elbows.' },
        { id: 'a2', name: 'Close-Grip Push-Ups', sets: 3, reps: 12, restSec: 45, gifName: 'close_grip_pushups', videoSource: 'close_grip_pushups', description: 'Hands close together. Elbows tight to ribs.' },
        { id: 'a3', name: 'Arm Circles', sets: 3, reps: 30, restSec: 20, unit: 'sec', gifName: 'arm_circles', videoSource: 'arm_circles', description: 'Extend arms at shoulder height. Make circles.' },
        { id: 'a4', name: 'Plank Shoulder Taps', sets: 3, reps: 20, restSec: 30, gifName: 'shoulder_taps', videoSource: 'shoulder_taps', description: 'In plank, tap opposite shoulder alternately.' },
        { id: 'a5', name: 'Inchworms', sets: 3, reps: 8, restSec: 45, gifName: 'inchworms', videoSource: 'inchworms', description: 'Walk hands out to plank and back.' },
        { id: 'a6', name: 'Pike Push-Ups', sets: 3, reps: 10, restSec: 45, gifName: 'pike_pushups', videoSource: 'pike_pushups', description: 'Inverted V position. Targets shoulders.' },
    ],
    legs: [
        { id: 'l1', name: 'Bodyweight Squats', sets: 4, reps: 15, restSec: 45, gifName: 'squats', videoSource: 'squats', description: 'Feet shoulder-width, squat until thighs parallel.' },
        { id: 'l2', name: 'Lunges', sets: 3, reps: 12, restSec: 45, gifName: 'lunges', videoSource: 'lunges', description: 'Step forward, lower until both knees at 90°.' },
        { id: 'l3', name: 'Jump Squats', sets: 3, reps: 10, restSec: 45, gifName: 'jump_squats', videoSource: 'jump_squats', description: 'Squat down then explosively jump up.' },
        { id: 'l4', name: 'Wall Sit', sets: 3, reps: 45, restSec: 30, unit: 'sec', gifName: 'wall_sit', videoSource: 'wall_sit', description: 'Back against wall, thighs parallel. Hold.' },
        { id: 'l5', name: 'Calf Raises', sets: 3, reps: 20, restSec: 30, gifName: 'calf_raises', videoSource: 'calf_raises', description: 'Rise up on toes, lower below step level.' },
        { id: 'l6', name: 'Glute Bridges', sets: 3, reps: 15, restSec: 30, gifName: 'glute_bridges', videoSource: 'glute_bridges', description: 'Lie on back, drive hips up squeezing glutes.' },
    ],
    fullbody: [
        { id: 'f1', name: 'Burpees', sets: 4, reps: 10, restSec: 60, gifName: 'burpees', videoSource: 'burpees', description: 'Drop to push-up, jump back up, jump with arms up.' },
        { id: 'f2', name: 'Jumping Jacks', sets: 3, reps: 30, restSec: 30, gifName: 'jumping_jacks', videoSource: 'jumping_jacks', description: 'Jump spreading legs and raising arms.' },
        { id: 'f3', name: 'Bear Crawls', sets: 3, reps: 30, restSec: 45, unit: 'sec', gifName: 'bear_crawls', videoSource: 'bear_crawls', description: 'All fours, knees hovering. Crawl around.' },
        { id: 'f4', name: 'High Knees', sets: 3, reps: 30, restSec: 30, unit: 'sec', gifName: 'high_knees', videoSource: 'high_knees', description: 'Run in place driving knees high.' },
        { id: 'f5', name: 'Squat to Press', sets: 3, reps: 12, restSec: 45, gifName: 'squat_press', videoSource: 'squat_press', description: 'Squat, then press arms overhead as you stand.' },
        { id: 'f6', name: 'Plank Jacks', sets: 3, reps: 20, restSec: 30, gifName: 'plank_jacks', videoSource: 'plank_jacks', description: 'In plank, jump feet out wide and back.' },
    ],
};
